...
async function detectClipboardCommand() {
    const commands = [
        { cmd: 'wl-copy', type: 'wayland', args: [] },
        { cmd: 'xclip', type: 'x11', args: ['-selection', 'clipboard'] },
        { cmd: 'xsel', type: 'x11', args: ['--clipboard', '--input'] }
    ];
...
async function setClipboard(text) {
    try {
        ...
        const command = `echo "${escapedText}" | ${cmd} ${args.join(' ')}`;
...
async function main() {
    ...
    console.log('╔═══════════════════════════════════════╗');
    console.log('║  Web Clipboard - Linux 客户端       ║');
    console.log('╚═══════════════════════════════════════╝');
    console.log('');
